<?php
if ( ! class_exists( 'Ideal_Magazine_List_Posts_Widget' ) ) {
	/**
	 * Adds Ideal_Magazine_List_Posts_Widget Widget.
	 */
	class Ideal_Magazine_List_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$ideal_magazine_list_posts_widget_ops = array(
				'classname'   => 'list-post ascendoor-widget style-1',
				'description' => __( 'Retrive List Posts Widgets', 'ideal-magazine' ),
			);
			parent::__construct(
				'ideal_magazine_list_posts_widget',
				__( 'Ascendoor List Posts Widget', 'ideal-magazine' ),
				$ideal_magazine_list_posts_widget_ops
			);
		}
