<?php
if ( ! class_exists( 'Ideal_Magazine_Trending_Posts_Widget' ) ) {
	/**
	 * Adds Ideal_Magazine_Trending_Posts_Widget Widget.
	 */
	class Ideal_Magazine_Trending_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$ideal_magazine_grid_widget_ops = array(
				'classname'   => 'trending-post-section ascendoor-widget',
				'description' => __( 'Retrive Trending Posts Widgets', 'ideal-magazine' ),
			);
			parent::__construct(
				'ideal_magazine_trending_posts_widget',
				__( 'Ascendoor Trending Posts Widget', 'ideal-magazine' ),
				$ideal_magazine_grid_widget_ops
			);
		}
